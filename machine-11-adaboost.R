...
# Train AdaBoost model using the ada function
adaboost_model <- ada(y_train ~ ., data = as.data.frame(X_train), iter = 50)


y_pred <- predict(adaboost_model, newdata = as.data.frame(X_test), type = "class")
